    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (decision.Equals("1"))
            {
                ...
                Location location = new Location("Bois de Boulogne");
                ...
                location.AddNPC(Astar);
                location.AddNPC(Peasant);
                location.AddNPC(Wanderer);
        ...
        static void ShowLocation(Location location) //metoda menu lokalizacji
        {
            do
            {
                Console.WriteLine("Znajdujesz się w: " + location.Name + ". Co chcesz zrobić ?");
                int i = 1;
                foreach (NonPlayerCharacter n in location.NPCs)             //pokazujemy NonPlayerCharacters tej lokacji
                {
                ...
                while (!(Int32.TryParse(decision, out number) && (number >= 1 && number <= location.NPCs.Count)) && !decision.Equals("X"))  //sprawdzanie poprawności wejscia
                {
                    Console.WriteLine("Wpisz poprawną liczbę");
                ...
                else
                {
                    ...
                    TalkTo(location.NPCs[number - 1], dp);            // number - 1 , bo numeracja listy od zera, a w menu mamy od 1
                }
            } while (true);
        }
        ...
        static string removeExtraSpaces(string s)    //usun niepotrzebne biłe znaki
        {
            string clear_name = "";
